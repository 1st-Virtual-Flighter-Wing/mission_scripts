local range_6_menu_root = MENU_MISSION:New("Range 6 SAM Evasion",range_root_menu6_10)
local range_6_menu_more = MENU_MISSION:New("more ...",range_6_menu_root)
---BASIC SEAD
--
...
function ThreatSite_7_threat_on()
  if ThreatSite_7 then
    ...
    Menu_ThreatSite_7_Off = MENU_MISSION_COMMAND:New("Deactivate SA-10",range_6_menu_root,ThreatSite_7_threat_off)
...
function ThreatSite_7_threat_off()
  if ThreatSite_7 then
    ...
    Menu_ThreatSite_7_On = MENU_MISSION_COMMAND:New("Activate SA-10",range_6_menu_root,ThreatSite_7_threat_on)
...
function ThreatSite_8_threat_on()
  if ThreatSite_8 then
    ...
    Menu_ThreatSite_8_Off = MENU_MISSION_COMMAND:New("Deactivate SA-11",range_6_menu_root,ThreatSite_8_threat_off)
...
function ThreatSite_8_threat_off()
  if ThreatSite_8 then
    ...
    Menu_ThreatSite_8_On = MENU_MISSION_COMMAND:New("Activate SA-11",range_6_menu_root,ThreatSite_8_threat_on)
...
function ThreatSite_9_threat_on()
  if ThreatSite_9 then
    ...
    Menu_ThreatSite_9_Off = MENU_MISSION_COMMAND:New("Deactivate SA-2",range_6_menu_root,ThreatSite_9_threat_off)
...
function ThreatSite_9_threat_off()
  if ThreatSite_9 then
    ...
    Menu_ThreatSite_9_On = MENU_MISSION_COMMAND:New("Activate SA-2",range_6_menu_root,ThreatSite_9_threat_on)
...
function ThreatSite_10_threat_on()
  if ThreatSite_10 then
    ...
    Menu_ThreatSite_10_Off = MENU_MISSION_COMMAND:New("Deactivate SA-15",range_6_menu_root,ThreatSite_10_threat_off)
...
function ThreatSite_10_threat_off()
  if ThreatSite_10 then
    ...
    Menu_ThreatSite_10_On = MENU_MISSION_COMMAND:New("Activate SA-15",range_6_menu_root,ThreatSite_10_threat_on)
...
function ThreatSite_11_threat_on()
  if ThreatSite_11 then
    ...
    Menu_ThreatSite_11_Off = MENU_MISSION_COMMAND:New("Deactivate SA-6",range_6_menu_root,ThreatSite_11_threat_off)
...
function ThreatSite_11_threat_off()
  if ThreatSite_11 then
    ...
    Menu_ThreatSite_11_On = MENU_MISSION_COMMAND:New("Activate SA-6",range_6_menu_root,ThreatSite_11_threat_on)
...
function ThreatSite_12_threat_on()
  if ThreatSite_12 then
    ...
    Menu_ThreatSite_12_Off = MENU_MISSION_COMMAND:New("Deactivate SA-8",range_6_menu_more,ThreatSite_12_threat_off)
...
function ThreatSite_12_threat_off()
  if ThreatSite_12 then
    ...
    Menu_ThreatSite_12_On = MENU_MISSION_COMMAND:New("Activate SA-8",range_6_menu_more,ThreatSite_12_threat_on)
...
function ThreatSite_13_threat_on()
  if ThreatSite_13 then
    ...
    Menu_ThreatSite_13_Off = MENU_MISSION_COMMAND:New("Deactivate SA-3",range_6_menu_more,ThreatSite_13_threat_off)
...
function ThreatSite_13_threat_off()
  if ThreatSite_13 then
    ...
    Menu_ThreatSite_13_On = MENU_MISSION_COMMAND:New("Activate SA-3",range_6_menu_more,ThreatSite_13_threat_on)
...
function ThreatSite_21_threat_on()
  if ThreatSite_21 then
    ...
    Menu_ThreatSite_21_Off = MENU_MISSION_COMMAND:New("Deactivate HAWK",range_6_menu_more,ThreatSite_21_threat_off)
...
function ThreatSite_21_threat_off()
  if ThreatSite_21 then
    ...
    Menu_ThreatSite_21_On = MENU_MISSION_COMMAND:New("Activate HAWK",range_6_menu_more,ThreatSite_21_threat_on)
...
function ThreatSite_22_threat_on()
  if ThreatSite_22 then
    ...
    Menu_ThreatSite_22_Off = MENU_MISSION_COMMAND:New("Deactivate SA-9",range_6_menu_more,ThreatSite_22_threat_off)
...
function ThreatSite_22_threat_off()
  if ThreatSite_22 then
    ...
    Menu_ThreatSite_22_On = MENU_MISSION_COMMAND:New("Activate SA-9",range_6_menu_more,ThreatSite_22_threat_on)
...
function ThreatSite_23_threat_on()
  if ThreatSite_23 then
    ...
    Menu_ThreatSite_23_Off = MENU_MISSION_COMMAND:New("Deactivate SA-13",range_6_menu_more,ThreatSite_23_threat_off)
...
function ThreatSite_23_threat_off()
  if ThreatSite_23 then
    ...
    Menu_ThreatSite_23_On = MENU_MISSION_COMMAND:New("Activate SA-13",range_6_menu_more,ThreatSite_23_threat_on)
...
function ThreatSite_24_threat_on()
  if ThreatSite_24 then
    ...
    Menu_ThreatSite_24_Off = MENU_MISSION_COMMAND:New("Deactivate MANPAD",range_6_menu_more,ThreatSite_24_threat_off)
...
function ThreatSite_24_threat_off()
  if ThreatSite_24 then
    ...
    Menu_ThreatSite_24_On = MENU_MISSION_COMMAND:New("Activate MANPAD",range_6_menu_more,ThreatSite_24_threat_on)
...
Menu_ThreatSite_23_On = MENU_MISSION_COMMAND:New("Activate SA-13",range_6_menu_more,ThreatSite_23_threat_on)
Menu_ThreatSite_24_On = MENU_MISSION_COMMAND:New("Activate MANPAD",range_6_menu_more,ThreatSite_24_threat_on)
Menu_Threat_ListActive = MENU_MISSION_COMMAND:New("List Active Threat Sites",range_6_menu_more, Sam_Footprints )
...
MENU_MISSION_COMMAND:New("Rearm all Threatsites",range_6_menu_root,resetrange)
