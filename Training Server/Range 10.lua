range_10_menu_root = MENU_MISSION:New("Range 10 SCAR/Strike",range_root_menu6_10)
...
local function range_10()
  ...
  local maxmovedistance =  2500 --max distance they move
