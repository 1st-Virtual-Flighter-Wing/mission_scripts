...
ctld.pickupZones = {
    { "FARP_ROME_PICKUP_ZONE", "none", -1, "yes", 2 },
    { "FARP_MADRID_PICKUP_ZONE", "none", -1, "yes", 2 },
    ...
    { "LHA-1 Tarawa", "blue", 20, "yes", 0 }, -- instead of a Zone Name you can also use the UNIT NAME of a ship
}
...
ctld.transportPilotNames = {
    ...
    "BLUE PLAYER UH-1 MADRID",
    "BLUE PLAYER MI-8 MADRID",
    "RED PLAYER MI-8 MADRID",
    "helicargo6",
    "helicargo7",
    "helicargo8",
    "helicargo9",
...
ctld.logisticUnits = {
    "BLUE FARP ROME LOGISTICS",
    "BLUE FARP MADRID LOGISTICS", -- removed this one from the map because it would make the match an instant-victory
    "logistic3",
    "logistic4",
    "logistic5",
    "logistic6",
...
function ctld.notifyCoalition(_message, _displayFor, _side)
    ...
    trigger.action.outSoundForCoalition(_side, "radio click.ogg")
end
